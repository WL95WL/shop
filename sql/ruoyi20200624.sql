...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='代码生成业务表';
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'LAPTOP-ITBCD0VC1592962272089', '1592962982286', '15000');
...
CREATE TABLE `store_ads` (
  ...
  `video_url` varchar(200) DEFAULT NULL COMMENT '视频url',
  `url` varchar(200) NOT NULL COMMENT '轮播图片地址',
  `type` tinyint(200) DEFAULT '1' COMMENT '类型1-视频 2-图片',
  `sort` smallint(4) unsigned DEFAULT '0' COMMENT '序号',
  `create_time` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='首页轮播广告';

-- ----------------------------
-- Records of store_ads
-- ----------------------------
INSERT INTO `store_ads` VALUES ('9', 'https://admin.mijia321.com/static/upload/e38690a86e1ef621/313ee2689043da13.mp4', 'http://tour.z-chip.com/2cd20a2f11084d4cbb0a8c884d0acce5.jpg', '1', '0', '0');
INSERT INTO `store_ads` VALUES ('11', '', 'http://tour.z-chip.com/11e52e6cad414babadaec7c939d827b2.jpg', '2', '0', '1536502777');
INSERT INTO `store_ads` VALUES ('12', '', 'https://img14.360buyimg.com/n0/jfs/t12679/142/442811935/74324/bb1f4629/5a0bf97cN3a76654f.jpg', '2', '0', '1536503300');
...
CREATE TABLE `store_cart` (
  ...
  `goods_logo` varchar(255) DEFAULT '',
  ...
  `spec_key` varchar(64) DEFAULT '' COMMENT '商品规格key 对应store_spec_goods_price 表',
...
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='购物车表';
...
) ENGINE=InnoDB AUTO_INCREMENT=9949 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='手机验证码表';
...
CREATE TABLE `store_comment` (
  ...
  `goods_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '商品id',
  `email` varchar(60) DEFAULT '' COMMENT 'email邮箱',
  `username` varchar(60) NOT NULL DEFAULT '' COMMENT '用户名',
  `content` text NOT NULL COMMENT '评论内容',
  `add_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  `ip_address` varchar(15) DEFAULT '' COMMENT 'ip地址',
  ...
  `deliver_rank` tinyint(1) unsigned DEFAULT '0' COMMENT '物流评价等级',
  `goods_rank` tinyint(1) DEFAULT '0' COMMENT '商品评价等级',
  `service_rank` tinyint(1) DEFAULT '0' COMMENT '商家服务态度评价等级',
  `zan_num` int(10) DEFAULT '0' COMMENT '被赞数',
  `zan_userid` varchar(255) DEFAULT '' COMMENT '点赞用户id',
  ...
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品评论表';
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='优惠券主表';
...
CREATE TABLE `store_coupon_list` (
  ...
  KEY `order_id` (`order_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='优惠券记录表';
...
CREATE TABLE `store_express` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=95 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商城快递配置';
...
CREATE TABLE `store_file_records` (
  ...
  `file_size` int(8) unsigned DEFAULT '0' COMMENT '文件大小',
  `create_time` int(11) unsigned DEFAULT '0' COMMENT '上传时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='文件上传记录表';
...
CREATE TABLE `store_goods` (
  ...
  `goods_logo` varchar(255) NOT NULL DEFAULT '' COMMENT '商品上传原始图(主图)',
  ...
  `spec_type` smallint(5) DEFAULT '0' COMMENT '商品规格类型，取值表goods_type的id',
  ...
  `goods_video` varchar(255) DEFAULT '' COMMENT '视频',
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品主表';

-- ----------------------------
-- Records of store_goods
-- ----------------------------
INSERT INTO `store_goods` VALUES ('4', '5', '0', '#10078', '复合门', '0', '1', '77', '0', '0', '0.0000', '140.00', '100.00', '0.00', null, '布料', '布料描述，布料描述，布料描述', '<p><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/145bb741db89d1a0/b7fbb8665bd0b890.jpg\" title=\"image\" /></p>', null, 'https://img14.360buyimg.com/n0/jfs/t12679/142/442811935/74324/bb1f4629/5a0bf97cN3a76654f.jpg', '0', '0', '0', '1', '1', '0', '0', '50', '1', '1', '0', '0', '39', '0', '10', '0', '0', '23', '0', '0', '0.00', '', '', '0', 'https://admin.mijia321.com/static/upload/e38690a86e1ef621/313ee2689043da13.mp4');
INSERT INTO `store_goods` VALUES ('5', '5', '0', '#10086', '低碳无漆', '0', '1', '172', '0', '0', '0.0000', '150.00', '100.00', '0.00', null, '枕芯', '枕芯这里是什么呢', '<p><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/5735b3971afb31b4/4056e87625d6308d.jpg\" title=\"image\" /></p>\r\n\r\n<p><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/2ca3e28f579f67bf/60adbbcf479f76a1.jpg\" title=\"image\" /></p>', null, 'https://img14.360buyimg.com/n0/jfs/t1/51802/22/15049/160740/5dbf97a8E18c34da3/e0eee8d81db4563c.jpg', '0', '0', '0', '1', '1', '0', '0', '50', '0', '1', '0', '0', '39', '0', '20', '0', '0', '28', '0', '0', '0.00', '', '', '0', 'https://admin.mijia321.com/static/upload/e38690a86e1ef621/313ee2689043da13.mp4');
INSERT INTO `store_goods` VALUES ('6', '5', '0', '10010', '门1', '0', '2', '19', '0', '0', '0.0000', '18.00', '22.00', '0.00', null, '123', '123123', '<p><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/90302f074f2f7060/17f5d62b05cccc78.jpg\" title=\"image\" /></p>', null, 'https://img14.360buyimg.com/n0/jfs/t1/116250/11/1171/78426/5e9520deE854f69b8/2dbe6b450225328f.jpg', '0', '0', '0', '1', '1', '0', '0', '50', '1', '0', '0', '0', '39', '0', '0', '0', '0', '3', '0', '0', '0.00', '', '', '0', '');
INSERT INTO `store_goods` VALUES ('7', '5', '0', '#45678', '门2', '0', '2', '12', '0', '0', '0.0000', '12.00', '22.00', '0.00', null, '12', '123123', '<p><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/1eaff416a8e9b845/ef5711e4c1995028.jpg\" title=\"image\" /></p>', null, 'https://img14.360buyimg.com/n0/jfs/t1/116250/11/1171/78426/5e9520deE854f69b8/2dbe6b450225328f.jpg', '0', '0', '0', '1', '1', '0', '0', '50', '1', '1', '0', '0', '39', '0', '0', '0', '0', '0', '0', '0', '0.00', '', '', '0', '');
INSERT INTO `store_goods` VALUES ('8', '4', '0', '#10096', '门3', '0', '1', '10', '0', '0', '0.0000', '9888.00', '6888.00', '0.00', null, '小米', '123', '<p><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/bbed0eba70c2018c/5b22ac2638e18245.jpg\" title=\"image\" /><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/137478132b12081d/8f46351f022872b4.jpg\" title=\"image\" /><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/0a78b71aebb5a39e/b64ce1f2ee6ac447.jpg\" title=\"image\" /><img border=\"0\" src=\"https://admin.mijia321.com/static/upload/b9d6ba99c4c6c55b/f4ed701f2ae71653.jpg\" title=\"image\" /></p>', null, 'https://img14.360buyimg.com/n0/jfs/t1/116250/11/1171/78426/5e9520deE854f69b8/2dbe6b450225328f.jpg', '0', '0', '0', '1', '1', '0', '0', '50', '1', '1', '0', '0', '39', '0', '0', '0', '0', '0', '0', '0', '0.00', '', '', '0', '');
INSERT INTO `store_goods` VALUES ('9', '11', '0', '#1008611', '门4', '0', '1', '10', '0', '0', '0.0000', '100.00', '20.00', '0.00', null, '复印', '描述', null, null, '', '0', '0', '0', '1', '1', '0', '0', '1', '0', '0', '0', '0', '39', '0', '0', '0', '0', '0', '0', '0', '0.00', '', '', '0', '');
...
-- ----------------------------
-- Records of store_goods_activity
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品关联的属性表(与商品相关)';
...
CREATE TABLE `store_goods_attribute` (
  ...
  `attr_type` tinyint(1) unsigned DEFAULT '0' COMMENT '0唯一属性 1单选属性 2复选属性',
  `attr_input_type` tinyint(1) unsigned DEFAULT '0' COMMENT ' 0 手工录入 1从列表中选择 2多行文本框',
...
) ENGINE=InnoDB AUTO_INCREMENT=332 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品的属性表(独立)';
...
CREATE TABLE `store_goods_brand` (
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='产品品牌';
...
CREATE TABLE `store_goods_cate` (
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商城商品分类';
...
CREATE TABLE `store_goods_collect` (
  ...
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `goods_id` (`goods_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=421 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品收藏表';
...
-- ----------------------------
-- Records of store_goods_consult
-- ----------------------------
...
CREATE TABLE `store_goods_feiqi` (
  ...
  `goods_no` varchar(50) DEFAULT '' COMMENT '货号',
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商城商品主表-废弃';
...
CREATE TABLE `store_goods_images` (
  ...
  KEY `goods_id` (`goods_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=552 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品相册';

-- ----------------------------
-- Records of store_goods_images
-- ----------------------------
INSERT INTO `store_goods_images` VALUES ('550', '4', 'http://tour.z-chip.com/20a60dbd290b4fbb82ea2ab9d618e0c7.jpg');
INSERT INTO `store_goods_images` VALUES ('551', '5', 'http://tour.z-chip.com/e1082cc6825d4a118e15d9c0aad6b2a0.jpg');
...
CREATE TABLE `store_goods_type` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品类型(商品模型)表';
...
CREATE TABLE `store_goods_visit` (
  ...
  KEY `user_id` (`user_id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=747 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='商品浏览历史表';

-- ----------------------------
-- Records of store_goods_visit
-- ----------------------------
...
CREATE TABLE `store_member` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `vip_no` varchar(10) DEFAULT '' COMMENT 'vip编号',
  ...
  `underling_number` int(5) unsigned DEFAULT '0' COMMENT '用户下线总数',
  `pay_points` int(8) unsigned DEFAULT '0' COMMENT '消费积分',
  `address_id` int(10) unsigned DEFAULT '0' COMMENT '默认收货地址',
  `remark` varchar(500) DEFAULT '' COMMENT '会员个性签名',
  `status` tinyint(1) unsigned DEFAULT '0' COMMENT '会员状态0待审核 1-已审核 2-已拒绝',
  `create_time` datetime DEFAULT NULL,
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `status_time` bigint(20) unsigned DEFAULT '0' COMMENT '审核时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `index_store_member_openid` (`openid`) USING BTREE,
  KEY `index_store_member_phone` (`phone`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商城会员信息';
...
CREATE TABLE `store_member_address` (
  ...
  `city_info` varchar(200) DEFAULT '' COMMENT '城市信息',
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商城会员收货地址';
...
CREATE TABLE `store_order` (
  ...
  `country` int(11) unsigned DEFAULT '0' COMMENT '国家',
  ...
  `city_info` varchar(200) DEFAULT '' COMMENT '地区地址',
  `address` varchar(255) NOT NULL DEFAULT '' COMMENT '地址详细地址',
  `zipcode` varchar(60) DEFAULT '' COMMENT '邮政编码',
  `mobile` varchar(60) NOT NULL DEFAULT '' COMMENT '手机',
  `email` varchar(60) DEFAULT '' COMMENT '邮件',
  `receive_type` tinyint(1) unsigned DEFAULT '1' COMMENT '收货方式 1-物流 2-快递 3-自取',
  `shipping_code` varchar(32) DEFAULT '' COMMENT '物流code 单号',
  ...
  `recharge_id` int(10) unsigned DEFAULT '0' COMMENT '支付方式为转账的转账id',
  ...
  `deleted_time` int(11) unsigned DEFAULT '0' COMMENT '删除|取消时间',
  `deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '用户假删除标识,1:删除,0未删除',
  `edit_money` varchar(50) DEFAULT '0.00' COMMENT '管理后台修改变动的价格',
  PRIMARY KEY (`order_id`) USING BTREE,
  UNIQUE KEY `order_sn` (`order_sn`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `add_time` (`add_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1869 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单主表';
...
CREATE TABLE `store_order_action` (
  ...
  KEY `order_id` (`order_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2532 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单日志表';
...
CREATE TABLE `store_order_express` (
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商城订单快递';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商城订单主表';

-- ----------------------------
-- Records of store_order_feiqi
-- ----------------------------
...
CREATE TABLE `store_order_goods` (
  ...
  `prom_type` tinyint(1) unsigned DEFAULT '0' COMMENT '0 普通订单,1 限时抢购, 2 团购 , 3 促销优惠,4预售',
  `prom_id` int(11) unsigned DEFAULT '0' COMMENT '活动id',
  ...
  KEY `order_id` (`order_id`) USING BTREE,
  KEY `goods_id` (`goods_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2178 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单商品表与订单主表关联';
...
INSERT INTO `store_order_goods` VALUES ('2174', '1867', '4', '小米8青春', 'https://img14.360buyimg.com/n0/jfs/t12679/142/442811935/74324/bb1f4629/5a0bf97cN3a76654f.jpg', '#10078', '2', '0.00', '80.00', '0.00', '0.00', '0', '8_11', '尺寸:300*500cm 颜色:黑色', '', '0', '0', '0', '0', '0', '');
INSERT INTO `store_order_goods` VALUES ('2175', '1867', '4', '小米8青春', 'https://img14.360buyimg.com/n0/jfs/t12679/142/442811935/74324/bb1f4629/5a0bf97cN3a76654f.jpg', '#10078', '3', '0.00', '90.00', '0.00', '0.00', '0', '8_12', '尺寸:300*500cm 颜色:紫色', '', '0', '0', '0', '0', '0', '');
...
CREATE TABLE `store_order_goods_remark` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='订单商品备注表';
...
CREATE TABLE `store_points_money_log` (
  ...
  `order_id` int(10) unsigned DEFAULT '0' COMMENT '关联的订单id 充值d订单或者消费订单',
  `user_id` int(11) NOT NULL DEFAULT '0' COMMENT '所有者的用户id',
  `title` varchar(150) NOT NULL DEFAULT '' COMMENT '积分或者红包日志标题',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=99 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='积分/余额日志(流水)表';
...
CREATE TABLE `store_recharge` (
  ...
  `from_type` tinyint(1) unsigned DEFAULT '1' COMMENT '充值转账来源1-充值 2-转账',
  `method_id` int(10) unsigned DEFAULT '0' COMMENT '充值方式id',
  `user_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '会员ID',
  `order_sn` varchar(30) NOT NULL DEFAULT '' COMMENT '充值单号',
  `screen_pic` varchar(200) DEFAULT '' COMMENT '转账截图',
  `account` decimal(10,2) DEFAULT '0.00' COMMENT '充值金额',
  `status_time` int(11) unsigned DEFAULT '0' COMMENT '审核日期',
  `ctime` int(11) DEFAULT NULL COMMENT '充值时间',
  `status` tinyint(1) DEFAULT '0' COMMENT '充值状态0:审核中 1:审核成功 2-审核失败',
  `remark` varchar(200) DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=283 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='充值或转账订单记录表';
...
CREATE TABLE `store_recharge_methods` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT '' COMMENT '充值方式名称',
  `icon` varchar(200) DEFAULT '' COMMENT '图标',
  `bank_name` varchar(30) DEFAULT '' COMMENT '银行名称，type=1才有',
  `type` tinyint(1) unsigned DEFAULT '1' COMMENT '充值类型1-银行 2微信 3-支付宝',
  `true_name` varchar(30) DEFAULT '' COMMENT '开户行/微信/支付账户用户姓名',
  `account` varchar(50) DEFAULT '' COMMENT '银行账户/微信号/支付宝账户',
  `qrcode` varchar(200) DEFAULT '' COMMENT '二维码图片，微信与支付宝才有',
  `sort` smallint(5) unsigned DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='充值或转账方式表';
...
CREATE TABLE `store_spec` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品规格表(独立)';
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='商品规格关联价格表';
...
CREATE TABLE `store_spec_item` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='规格项';
...
CREATE TABLE `store_substitute` (
  ...
  `username` varchar(30) NOT NULL DEFAULT '' COMMENT '收货人姓名',
  `phone` varchar(20) NOT NULL COMMENT '收货手机号',
  `city_info` varchar(100) DEFAULT '' COMMENT '城市信息',
  `address` varchar(200) DEFAULT '' COMMENT '收货详细地址',
  `product_info` text COMMENT '产品明细',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代发货表';
...
CREATE TABLE `store_substitute_order` (
  ...
  `sub_ids` text NOT NULL COMMENT '代发商品关联id 逗号隔开',
  `order_sn` varchar(20) NOT NULL COMMENT '订单号',
  `shipping_name` varchar(50) DEFAULT '' COMMENT '物流名称',
  `shipping_code` varchar(50) DEFAULT '' COMMENT '物流code 单号',
  ...
  `order_status` tinyint(1) unsigned DEFAULT '0' COMMENT '订单状态0-待确认 1-已确认',
  `pay_method` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '支付方式1-微信2-余额3-转账',
  `recharge_id` int(10) unsigned DEFAULT '0' COMMENT '支付方式为转账的转账id',
  `pay_status` tinyint(1) unsigned DEFAULT '0' COMMENT '支付状态 0-待付款 1-已付款',
  `shipping_status` tinyint(1) unsigned DEFAULT '0' COMMENT '发货状态 0-未发货 1-已发货 2-已收货',
  `create_time` int(11) unsigned DEFAULT '0' COMMENT '创建时间',
  `pay_time` int(11) unsigned DEFAULT '0' COMMENT '支付时间',
  `shipping_time` int(11) unsigned DEFAULT '0' COMMENT '发货时间',
  `is_deleted` tinyint(1) unsigned DEFAULT '0' COMMENT '1:删除,0未删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代发订单';
...
CREATE TABLE `store_substitute_order_goods` (
  ...
  `product_info` text COMMENT '产品明细',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='代发订单货物表';
...
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户等级表';
...
) ENGINE=InnoDB AUTO_INCREMENT=433 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
...
) ENGINE=InnoDB AUTO_INCREMENT=1107 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '/profile/avatar/2020/06/23/061dc4cc0b6c6ff94eb0dc330efd2bef.png', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2020-06-22 09:28:22', 'admin', '2018-03-16 11:33:00', 'ry', '2020-06-23 16:43:05', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('6960258c-fbd0-4dff-b027-f7e4cfdae869', 'admin', '助理部门', '127.0.0.1', '内网IP', 'Chrome 8', 'Windows 10', 'on_line', '2020-06-24 09:33:41', '2020-06-24 09:33:41', '1800000');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信图文表';
...
CREATE TABLE `wechat_news_article` (
  ...
  `create_by` bigint(20) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='微信素材表';
